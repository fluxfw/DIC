 ...
 * Output HTML or GUI
 * 
 * @param string|ilTemplate|ilConfirmationGUI|ilPropertyFormGUI|ilTable2GUI|Component|ilModalGUI|ilAdvancedSelectionListGUI $html HTML code or some GUI instance
